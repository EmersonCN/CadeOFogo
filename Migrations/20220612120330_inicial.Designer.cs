...
namespace CadeOFogo.Migrations
{
    ...
    [Migration("20220612120330_inicial")]
            ...
            modelBuilder.Entity("CadeOFogo.Models.Inpe.Foco", b =>
                {
                    ...
                    b.HasOne("CadeOFogo.Models.Inpe.TipoVegetacao", "TipoVegetacao")
                        .WithMany("FocoCollection")
                        .HasForeignKey("TipoVegetacaoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
